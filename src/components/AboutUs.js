  ...
  return (
    <div id="about-us" className="relative ">
      <motion.img
        ...
        className="absolute pointer-events-none top-1/4 left-1/3 transform rotate-12 w-20 z-1"
        src="/imgs/fig.png"
        alt="card"
      />
      <motion.img
      ...
      <div className="my-container flex flex-col lg:flex-row items-center lg:gap-20 xl:gap-20 pb-20">
        ...
        <div className="lg:w-1/2 pt-40 lg:pt-0 lg:pl-10 xl:pl-0">
          ...
          <SubHeading>
            ...
            cross 8888 fruit who wear some sick kicks, and have different
            attributes, and clothing? You get our own grown collection of Juicy
            Kicks. There are over 30 different types of fruit, over 100
            different clothing and layers, and every Juicy Kick is unique and
            looking for a home!
          </SubHeading>
        </div>
      </div>
