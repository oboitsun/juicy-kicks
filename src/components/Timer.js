...
export default function Timer() {
  ...
  const dayX = new Date("December 28, 2022 00:00:00").getTime();
  ...
  return (
    <div className=" flex items-center mt-5 pt-5 lg:pt-0  mb-4 lg:mb-6 lg:mt-4 relative ">
      <p className="text-xs lg:text-center text-white uppercase absolute -top-2 lg:left-1/2  transform lg:-translate-x-1/2">
        time till launch:
      </p>
      <img
